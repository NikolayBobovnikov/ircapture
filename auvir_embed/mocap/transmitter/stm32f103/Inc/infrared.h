...
#define PreambleBitLength           (600 - 1)    // 270 works not reliably; 280 works;  chosen more
#define PreambleDelayLength         (600 - 1)    // 270 works not reliably; 280 works;  chosen more
#define DataBitLength               (400 - 1)    // TODO: Need to be distinguishable from start/stop bits. Start/Stop bit should on and off in less than data bit length
