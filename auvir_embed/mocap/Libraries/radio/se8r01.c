...
static void nrf24_setup_modules_gpio()
{
    ...
    default_module.CE.Port = NRF24_CE1_Port;
    default_module.CSN.Pin = NRF24_CSN1_Pin;
    default_module.CSN.Port = NRF24_CSN1_Port;
    default_module.IRQ.Pin = NRF24_IRQ1_Pin;
    default_module.IRQ.Port = NRF24_IRQ1_Port;

    data_module.CE.Pin  = NRF24_CE2_Pin;
    data_module.CE.Port = NRF24_CE2_Port;
    data_module.CSN.Pin = NRF24_CSN2_Pin;
    data_module.CSN.Port= NRF24_CSN2_Port;
