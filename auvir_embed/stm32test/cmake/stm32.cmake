...
SET(TOOLCHAIN_DIR /home/nikolay/work/dev/auvir/auvir_embed/toolchain/gcc-arm-none-eabi-4_9-2015q2)
# STM Library directory
SET(STM32_StdPeriphLib_DIR /home/nikolay/work/dev/thirdparty/baremetal/stm32/STM32F10x_StdPeriph_Lib_V3.5.0)
...
find_program(COMPILER_C ${TARGET_TRIPLET}-gcc ${TOOLCHAIN_BIN_DIR})
find_program(COMPILER_CXX ${TARGET_TRIPLET}-g++ ${TOOLCHAIN_BIN_DIR})
find_program(COMPILER_AS ${TARGET_TRIPLET}-as ${TOOLCHAIN_BIN_DIR})
CMAKE_FORCE_C_COMPILER(${COMPILER_C} GNU)
CMAKE_FORCE_CXX_COMPILER(${COMPILER_CXX} GNU)
#SET(CMAKE_C_COMPILER ${COMPILER_C} CACHE INTERNAL "")
#SET(CMAKE_CXX_COMPILER ${COMPILER_CXX} CACHE INTERNAL "")
SET(CMAKE_ASM_COMPILER ${COMPILER_AS} CACHE INTERNAL "")
...
find_program(OBJCOPY_PRG ${TARGET_TRIPLET}-objcopy ${TOOLCHAIN_BIN_DIR})
find_program(OBJDUMP_PRG ${TARGET_TRIPLET}-objdump ${TOOLCHAIN_BIN_DIR})
SET(CMAKE_OBJCOPY ${OBJCOPY_PRG} CACHE INTERNAL "")
SET(CMAKE_OBJDUMP ${OBJDUMP_PRG} CACHE INTERNAL "")
